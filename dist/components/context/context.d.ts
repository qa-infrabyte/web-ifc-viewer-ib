...
export declare class IfcContext {
    ...
    castRay(items: Object3D[]): import("three").Intersection<Object3D<import("three").Object3DEventMap>>[];
    castRayIfc(): import("three").Intersection<Object3D<import("three").Object3DEventMap>> | null;
    fitToFrame(): void;
