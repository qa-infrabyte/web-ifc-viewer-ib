...
export declare class Edges {
    ...
    getAll(): string[];
    get(name: string): {
        edges: LineSegments<import("three").BufferGeometry<import("three").NormalBufferAttributes>, Material | Material[]>;
        originalMaterials: Material | Material[];
        baseMaterial: Material | undefined;
        model: Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes>, Material | Material[], import("three").Object3DEventMap>;
        active: boolean;
    };
